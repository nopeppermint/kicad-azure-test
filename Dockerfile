...
ENV PATH=C:\_tools\cmake-3.14.4-win64-x64\bin;%PATH%
...
RUN cd kicad-winbuilder && C:\_tools\cmake-3.14.4-win64-x64\bin\cmake.exe --debug --trace -Dx86_64=ON  -P KiCad-Winbuilder.cmake
